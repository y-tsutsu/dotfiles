...
# etc.
sudo aptitude install ruby nodejs tig libncurses5-dev gdb valgrind strace meld clipit fonts-inconsolata libappindicator-dev curl \
graphviz doxygen gtk2-engines-murrine gconf2 locate -y
