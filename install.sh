...
# python
sudo apt install libsqlite3-dev libreadline-dev libgdbm-dev zlib1g-dev libbz2-dev sqlite3 tk-dev zip libssl-dev -y
...
graphviz doxygen gconf2 locate rpm exuberant-ctags -y
